...
class ImageMaker:
    ...
    def __init__(self, weather, choice_date=1):
        """
        :param weather: Данные о погоде на 5 дней.
        :param choice_date: День для которого необходимо сделать открытку.
        """
        self.temp = weather[choice_date - 1]['temp']
        self.date = weather[choice_date - 1]['date']
        self.weather = weather[choice_date - 1]['weather']
        self.wind = weather[choice_date - 1]['wind']
        self.city = weather[choice_date - 1]['city']
        self.image = None
        self.result = None
